...
| Fonts: Space Grotesk, Inter, Rounded M+, Nunito, Baloo 2, Fredoka, Lexend, IBM Plex Sans, Noto Sans, Noto Sans CJK SC, Source Han Sans, Leaf Han Sans JP (Source Han Sans, subset and renamed) | SIL OFL 1.1 |
...
under GPL-3.0-or-later. UMRK's [Leaf content pak](https://github.com/Utility-Muffin-Research-Kitchen/DSperate-pak)
packages their work for MLP1. You can install it through Pak Rat on Leaf 0.12.0
or newer.
