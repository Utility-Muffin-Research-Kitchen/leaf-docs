...
| An Advanced shader disappears after you exit | This is expected after **Apply** or **Load** unless you use RetroArch's native save action. Choose **Save Current Preset** before leaving the Advanced Shaders screen |
